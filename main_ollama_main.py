...
# Fixed missing imports needed for your Ollama and tool definitions:
...
agent = create_tool_calling_agent(model, tools, agentPrompt) # Fixed: variable case matched to agentPrompt
...
# making it work
# Logic Fix: Because you wanted your loop to use conversationalRAGagent, we link it here using your RAGchain logic pipeline
conversationalRAGagent = RunnableWithMessageHistory(
    RAGchain,
    getsessionhistory,
